...
{
    &Tools::DirectShow::CLSID_DumpFilter, // Filter CLSID
    L"Dump",                              // String name
...
CFactoryTemplate g_Templates[]= {
    L"Dump", &Tools::DirectShow::CLSID_DumpFilter, CDump::CreateInstance, NULL, &sudDump
};
int g_cTemplates = 1;
...
CDumpFilter::CDumpFilter(CDump *pDump,
                         ...
                         CCritSec *pLock,
                         HRESULT *phr) :
    CBaseFilter(NAME("CDumpFilter"), pUnk, pLock, Tools::DirectShow::CLSID_DumpFilter),
    m_pDump(pDump)
{
}
